...
export class ArmoryComponent implements OnInit {
    weapons:Array<Weapon> = [
        ...
        new Weapon("The Colony", 'Grenade Launcher', 'Heavy','https://bungie.net/common/destiny2_content/icons/dadeb1f4484ffdaec2420240700dc637.jpg','https://bungie.net/common/destiny2_content/screenshots/3899270607.jpg',0,0)
    ]
